...
export function setLocaleCookie(locale) {
  const { useCookie, cookieKey, cookieDomain, cookieSecure, cookieCrossOrigin } = nuxtI18nOptions.detectBrowserLanguage || nuxtI18nOptionsDefault.detectBrowserLanguage;
  if (!useCookie) {
    return;
  }
