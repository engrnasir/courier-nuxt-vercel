...
const en_info = ref({
    ...
    AEROPOST WILL NOT TRANSPORT THESE ITEMS AND NO CLAIMS WILL BE ACCEPTED FOR IT.<br><br>
    `,
    desc2:`
...
const es_info = ref({
    desc1:`
        ...
        AEROPOST NO TRANSPORTARÁ ESTOS ARTÍCULOS NI SE ACEPTARÁN RECLAMACIONES POR ÉL.<br><br>
    `,
    desc2:`
